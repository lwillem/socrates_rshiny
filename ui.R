  ...
  mainPanel(
    ...
    tabsetPanel(type = "tabs",
                ...
                tabPanel("Infection rates",
                         helpText('This matrix represents the average number of infections caused by infected individuals between age-groups.'),
                         plotOutput('plot_NGM',width = "80%", height = "300px"),
                         helpText('The barplot presents the reproduction number and the average number of infections caused by an infected individual in each age-group.'),
                         plotOutput('plot_mean_number_infected',width = "80%", height = "300px"),
                         helpText('The barplot presents the probability distribution of infected by age-group.'),
                         plotOutput('plot_stable_distribution',width = "80%", height = "300px")),
